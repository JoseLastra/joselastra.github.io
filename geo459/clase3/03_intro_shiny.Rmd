...
--
- En términos simples: [shiny](https://cran.r-project.org/web/packages/shiny/index.html) |  [![CRAN](https://www.r-pkg.org/badges/version/shiny)](https://CRAN.R-project.org/package=shiny) es un paquete de R, que permite conectar la ciencia de datos con la difusión.
...
--
.center[
[![:scale 30%](https://d33wubrfki0l68.cloudfront.net/0c97eee3d8fc820f3a8d670c08b286e8a524257b/e426c/cover.png)](https://mastering-shiny.org/)
]

--
- Libro de [Hadley Wickham](https://github.com/hadley) que considera una introducción muy buena al mundo de *shiny* desde aspectos elementales hasta aspectos más avanzados de desarrollo de aplicaciones.
