...
---
# Convirtiendo a mapa dinámico

--
- Un paso clave es guardar nuestro mapa en un objeto siguiendo el ejemplo
...
--
- Acá utilizaremos la función *st_cast()* para pasar nuestro archivo a tipo puntos ya que, hasta la fecha no hay soporte para tipo multipuntos en leaflet.
