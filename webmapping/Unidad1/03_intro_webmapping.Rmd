...
--
.pull-right[
- *Geo-web*: Tecnologías web disponibles para el análisis 
de información espacial
- *Web GIS*: Utilizan tecnologías web como un método de 
comunicación entre los elementos de un SIG
- *Webmapping*:  Aplicaciones en línea que permiten a los 
...
.footnote[- [Explorador de precipitaciones CR2](http://mawun.cr2.cl/)]
.footnote[- [CAMELS-CL CR2](http://camels.cr2.cl/)]
...
--
- La base está en el uso de conductores reactivos que facilitan el desarrollo de los procesos
...
--
- La función *shinyApp(ui, server)* compila nuestra aplicación uniendo los dos componentes.
...
--
- El funcionamiento dentro del server debe estar estructurado según los elementos en la UI e idealmente debe estar modularizado para identificar posibles fallos. 

---
class: middle, center

<iframe width="800" height="500" src="https://www.youtube.com/embed/onMaUQaxUeo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

---
#Agregando elementos

--
- Dentro de nuestras aplicaciones podemos hacer uso de diferentes elementos disponibles dentro de la librería shiny.

--
- Además podemos ajustar estos elementos y considerar procesamiento y bloques de código dentro de nuestro servidor.

--
- A continuación veremos como ordenar de forma elemental nuestra UI y poner elementos en el SERVER.

---

class: middle, center

<iframe width="800" height="500" src="https://www.youtube.com/embed/nicSZixRMi8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

---
#Conductores reactivos

--
- En el contexto de un script de *shiny*, la mayoría de las cosas se efectúan mediante elementos reactivos.
...
--
- Como veremos más adelante son escenciales para los mapas web.

--
- A continuación incursionaremos en el uso de estos conductores.

---
class: middle, center

<iframe width="800" height="500" src="https://www.youtube.com/embed/gn9tv3nbLu8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
